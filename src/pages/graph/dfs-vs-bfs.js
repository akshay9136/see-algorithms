  ...
  return (
    <Stack spacing={3}>
      <Typography variant="body1">
        Compare <strong>Depth-First Search (DFS)</strong> and{' '}
        <strong>Breadth-First Search (BFS)</strong> side-by-side to witness their
        ...
        PLAY to watch these two fundamental algorithms compete on the same structure.
      </Typography>
