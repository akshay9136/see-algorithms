...
export default function EmbedGraph() {
  return (
    <Article
      ...
      summary="A practical guide on how to embed interactive graph visualizations into your website, blog, or course materials."
    >
      <Section title="Why Embed Graphs?">
      ...
      <Section title="How to Embed">
        <Typography paragraph>
          Each graph algorithm has a dedicated embed page that strips away the
          site navigation and article content, leaving only the interactive
          canvas and controls. To use it, place the embed URL inside a standard
          HTML iframe element.
        </Typography>
...
Hamiltonian  - Hamiltonian Cycle`}
      ...
      <Section title="Choosing the Right Size">
        <Typography paragraph>
          ...
          container, while the height should generally be 700 pixels. Algorithms
      ...
      <Section title="Final Reflection">
        ...
        <Typography paragraph>
          Whether you’re illustrating BFS traversal or comparing MST strategies,
          a simple iframe is all it takes to turn abstract graph theory into a
          tangible, interactive experience.
        </Typography>
      </Section>
    </Article>
  );
