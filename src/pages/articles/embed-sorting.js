    ...
    >
      ...
      <Section title="How to Embed">
        <Typography paragraph>
          ...
          URL. Each sorting visualizer has a dedicated embed path. The embedded visualizer handles its own
          state, layout, and interactivity without taking up unnecessary space.
        </Typography>
